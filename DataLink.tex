...
contains the query result. To describe an associated service, the VOTable documement
...
user-specified parameters are optional and services should respond with an informative error
