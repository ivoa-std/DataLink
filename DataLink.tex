...
A free name  SHOULD be added to each descriptor RESOURCE to help identifying the meaning.\\
...
A service RESOURCE SHOULD contain a DESCRIPTION element to explain the purpose of the service.
...
\begin{verbatim}
   <RESOURCE type="meta" utype="adhoc:service" name="{links} for
Obscore">
...
\begin{verbatim}
   <RESOURCE type="meta" utype="adhoc:service" name="My SIA service">
     <DESCRIPTION> This is service SIA for so and so</DESCRIPTION>
...
\begin{verbatim}
   <RESOURCE type="meta" utype="adhoc:service" ID="vnodes" name="My VOSPACE">
     <DESCRIPTION>A nice container to share space</DESCRIPTION>
...
{\small
\begin{verbatim}
   <RESOURCE type="meta" utype="adhoc:service" ID="apoadimo" name="Custom Recalibration">
     <DESCRIPTION>Custom APOADIMO spectrum recalibration service</DESCRIPTION>
...
\begin{verbatim}
   <RESOURCE type="meta" utype="adhoc:service" name="this">
     <DESCRIPTION> DataLink service autodescription </DESCRIPTION>
     <PARAM name="standardID" datatype="char" arraysize="*"
            value="ivo://ivoa.net/std/DataLink#links-1.0" />
     <PARAM name="accessURL" datatype="char" arraysize="*"
            value="http://example.com/mylinks" />
