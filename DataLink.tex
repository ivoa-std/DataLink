...
and add it to a VOTable document. This ``service descritor'' mechanism can also 
...
For user-specified input PARAMs the value attribute is normally empty (\attval{value}{}) 
...
on possible values. In general, services maybe have parameters of this type that are optional
or required and this distinction is not currently described. Clients should assume that these
user-specified parameters are optional, but that specifiying at least one of them is necessary 
