...
as the default output format for both successful
...
to the DALI-sync description. The implementer is free to name for this
...
(as allowed for MIME types, \citet{misc:mime-tsv}).
...
is described by following resource:
\begin{verbatim}
...
it's normal output. This usage is comparable to prototype work on S3
(see \citet{note:s3})
