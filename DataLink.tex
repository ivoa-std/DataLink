...
a different format, the content-type header of the response {\bf must} be one of the 
...
\end{verbatim}
From version 1.1 of this standard, the \blinks\ response {\bf must} include this 
