...
of the service query to a web browser.  This is appropriate for both HTML
 ...
 exampleURL is supposed to be a valid service URL which can be generated by 
 the  client using service descriptor rules or inputs by the user.
 Clients SHOULD display exampleURL to the user.
