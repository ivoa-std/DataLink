...
This specification defines mechanisms for connecting metadata items
...
for drilling
down from a discovered data/metadata item such as an identifier,
...
data/metadata item in some way: get additional metadata, download the data, or
