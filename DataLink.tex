...
In various other IVOA service responses the \blinks\ endpoint URL recognition is not explicitely normalizedi by service specification. In these usecases it's worth reading the DataLink recognition implementation note\footnote{at the time of writing: http://github.com/ivoa/DataLinkRecImplNote}. 
